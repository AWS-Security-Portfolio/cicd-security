...
- [AWS CI/CD Security Best Practices](https://docs.aws.amazon.com/prescriptive-guidance/latest/patterns/implement-secure-ci-cd-on-aws.html)
- [pytest](https://docs.pytest.org/en/7.1.x/)
- [pylint](https://pylint.pycqa.org/en/latest/)
- [AWS CodeGuru Reviewer](https://docs.aws.amazon.com/codeguru/latest/reviewer-ug/welcome.html)
